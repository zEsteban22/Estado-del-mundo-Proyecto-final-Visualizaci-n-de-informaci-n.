...
df_universal=pd.DataFrame([ 
    {#                                                _.-=/ Esta parte es para sacar los registros en un rango de 5 años \=-._                _.-=/ Aquí se hace el pegue por código \=-._                 v Para finalmente sacar el promedio del indicador
        'gasesEIPercap':df_gasesEfectoInvernadero[df_gasesEfectoInvernadero['Año'].between(registro_poblacion['Año']-2,registro_poblacion['Año']+3)][df_gasesEfectoInvernadero['Código']==registro_poblacion['Código']]['Emisiones'].mean()/registro_poblacion['Población'],
...
def generarGraficos(año):
    ...
    return \
        ...
        px.scatter(df_temp,
            ...
            height=700,
            hover_name='Entidad'),\
        px.parallel_coordinates(df_temp,
